            ...
            <div className="--card --card-blue --mr">
              ...
              <ul className="coin-details">
                ...
                <li>
                  ...
                  <span>${formatNumbers(coin.marketCap.toFixed(2))}</span>
                </li>
                <li>
                  <span>Total Supply:</span>
                  <span>{formatNumbers(coin.totalSupply)}</span>
                </li>
                <li>
                  <span>Website :</span>
                  <span>
...
export const getStaticPaths = async ({ coins, setCoins }) => {
  const id = context.params.id;
  const res = await axios.get("https://api.coinstats.app/public/v1/coins/" + i);
...
export const fetchData = async (context, { coins, setCoins }) => {
  const id = context.params.id;
